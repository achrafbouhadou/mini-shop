    ...
    <Layout>
              ...
              <tr key={p.id} className="border-t">
                ...
                <td className="p-3">
                  <div className="flex gap-2">
                    ...
                    <button className="px-3 py-1.5 rounded-lg border text-red-600 hover:bg-red-50"
      ...
      {modal && (
        <div className="fixed inset-0 z-20 grid place-items-center bg-black/30 p-4">
          <div className="bg-white rounded-2xl w-full max-w-xl p-4 shadow-lg">
            <div className="flex items-center justify-between mb-3">
              <h3 className="text-lg font-semibold">{modal.mode === 'create' ? 'New product' : 'Edit product'}</h3>
              <button className="text-slate-500 hover:text-slate-700" onClick={() => setModal(null)}>✕</button>
            </div>
            <ProductForm
              mode={modal.mode}
